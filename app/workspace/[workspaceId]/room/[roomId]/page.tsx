...
import { ArrowLeft, Loader2, Presentation, FileCode, Trello } from "lucide-react";
...
import { KanbanBoardList } from "@/components/kanban/kanban-board-list";
...
export default function RoomPage() {
  ...
  // For kanban rooms, show kanban board list
  if (room.type === "kanban") {
    return (
      <div className="fixed inset-0 flex flex-col bg-background">
        {/* Header */}
