  ...
  return (
    <div className="min-h-screen bg-[#0b0f1a] text-white overflow-x-hidden relative">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none z-0">
        ...
        <div
          className="absolute bottom-[20%] left-[5%] w-[600px] h-[600px] rounded-full bg-gradient-radial from-indigo-500/20 via-sky-500/15 to-transparent blur-[120px] animate-pulse"
      ...
      <section className="relative overflow-hidden z-10">
        <div className="max-w-7xl sm:px-6 lg:px-8 sm:py-28 mr-auto ml-auto pt-20 pr-4 pb-20 pl-4">
          <div className="mx-auto max-w-4xl text-center space-y-8">
            {/* VBase Brand */}
            <div
              className="flex items-center justify-center opacity-0 animate-blur-in"
              style={{ opacity: 1 }}
            >
            ...
            <h1
              className="text-4xl sm:text-5xl lg:text-6xl leading-[1.1] text-white opacity-0 animate-blur-in tracking-tighter animate-delay-200"
              style={{ opacity: 1 }}
            >
              Virtual Workspace.{" "}
              <span className="bg-clip-text text-transparent bg-gradient-to-r from-sky-400 to-indigo-400 tracking-tighter">
                Supercharged.
              </span>
            </h1>
            <p
              className="text-lg sm:text-xl text-white/70 max-w-2xl mx-auto opacity-0 animate-slide-up animate-delay-300"
              style={{ opacity: 1 }}
            >
              Create collaborative workspaces with integrated coding rooms,
              whiteboards, video meetings, and Kanban boards. All in real-time.
            </p>
            <div
              className="flex flex-col sm:flex-row items-center justify-center gap-4 pt-4 opacity-0 animate-scale-in animate-delay-500 relative z-10"
              style={{ opacity: 1 }}
            >
              <MovingBorderButton
                onClick={onGetStarted}
          ...
          {/* Product Preview */}
          <div
            className="sm:mt-24 opacity-0 animate-blur-in animate-delay-700 relative mt-16 transition-transform duration-500 hover:-translate-y-2"
            style={{ opacity: 1 }}
          >
            <div className="relative rounded-3xl border border-white/20 bg-gradient-to-b from-slate-900/40 to-slate-800/30 shadow-[0_10px_60px_-15px_rgba(0,0,0,0.6)] overflow-hidden hover:shadow-[0_20px_80px_-15px_rgba(0,0,0,0.8)] hover:border-white/15 transition-all duration-500 backdrop-blur-xl">
                    ...
                    <div className="relative h-80">
                      ...
                      <div className="absolute inset-0 overflow-hidden pt-6 pr-6 pb-6 pl-6 space-y-4">
                        ...
                        {[
                          ...
                          <div
                            key={room.name}
                            className="flex items-center gap-4 p-4 rounded-lg bg-slate-900/40 border border-white/5 hover:bg-slate-900/80 hover:border-white/10 transition-all duration-300 group"
                          >
                            ...
                            <div className="flex-1 min-w-0">
                              <div className="flex items-center gap-3 text-sm">
                                <span className="text-slate-200 font-medium truncate group-hover:text-white transition-colors duration-200">
                                  {room.name}
                                </span>
                                <span className="px-2 py-0.5 text-xs rounded-full bg-purple-500/15 text-purple-300 border border-purple-500/20">
                                  {room.badge}
                                </span>
                              </div>
                            ...
                            <div className="flex items-center gap-3">
                              <span
                                className={`h-6 w-6 rounded-full bg-gradient-to-br ${room.color} flex items-center justify-center text-xs text-white font-semibold group-hover:scale-110 transition-transform duration-200`}
                              >
                                {room.users}
                              </span>
              ...
              <div className="relative z-10 pt-8 pr-8 pb-8 pl-8">
                <div className="w-full px-2 py-2">
                  ...
                  <h2 className="mt-4 text-3xl sm:text-4xl text-white tracking-tighter">
                    Collaborative Workspaces
                  </h2>
                  <p className="sm:text-lg text-base text-slate-400 mt-4">
                    Create virtual offices with specialized rooms for every team
                    need. From coding together to brainstorming on whiteboards,
                    VBase brings your team together in real-time.
                  </p>
                </div>
              </div>
            </div>
      ...
      <section
        id="features"
        className="relative sm:py-28 section-divider pt-20 pb-20 space-y-20 z-10"
      >
        <div className="max-w-7xl sm:px-6 lg:px-8 mx-auto px-4">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <h2
              className="text-3xl sm:text-4xl text-white opacity-0 animate-blur-in tracking-tighter"
              style={{ opacity: 1 }}
            >
              Built for modern teams
            </h2>
            <p
              className="mt-4 text-lg text-white/70 opacity-0 animate-slide-up animate-delay-200"
              style={{ opacity: 1 }}
            >
              Every tool your team needs to collaborate effectively in one
              unified workspace.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div
              className="hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl transition-all duration-500 opacity-0 animate-blur-in animate-delay-300 group bg-white/5 border-white/10 border rounded-2xl pt-8 pr-8 pb-8 pl-8"
              style={{ opacity: 1 }}
            >
              ...
              <h3 className="text-xl font-semibold text-white mb-3 group-hover:text-sky-300 transition-colors duration-300">
                Real-time Collaboration
              </h3>
              <p className="text-white/70 leading-relaxed group-hover:text-white/90 transition-colors duration-300">
                Work together seamlessly with instant updates across all
                workspace rooms and tools.
              </p>
            </div>

            <div
              className="hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl transition-all duration-500 opacity-0 animate-blur-in animate-delay-400 group bg-white/5 border-white/10 border rounded-2xl pt-8 pr-8 pb-8 pl-8"
              style={{ opacity: 1 }}
            >
              ...
              <p className="text-white/70 leading-relaxed group-hover:text-white/90 transition-colors duration-300">
                Built for speed with optimized performance and real-time
                synchronization.
              </p>
            </div>

            <div
              className="hover:bg-white/8 hover:border-white/20 hover:scale-105 hover:shadow-2xl transition-all duration-500 opacity-0 animate-blur-in animate-delay-500 group bg-white/5 border-white/10 border rounded-2xl pt-8 pr-8 pb-8 pl-8"
              style={{ opacity: 1 }}
            >
              ...
              <p className="text-white/70 leading-relaxed group-hover:text-white/90 transition-colors duration-300">
                Enterprise-grade security with encrypted connections and private
                workspaces.
              </p>
            </div>
          </div>
        ...
        <div className="max-w-7xl sm:px-6 lg:px-8 mt-20 mr-auto ml-auto pr-4 pl-4">
          <div className="mx-auto max-w-3xl text-center mb-16">
            <h2
              className="text-3xl sm:text-4xl text-white opacity-0 animate-blur-in animate-delay-600 tracking-tighter"
              style={{ opacity: 1 }}
            >
              Specialized rooms for every workflow
            </h2>
            <p
              className="mt-4 text-lg text-white/70 opacity-0 animate-slide-up animate-delay-700"
              style={{ opacity: 1 }}
            >
              From coding together to planning sprints, VBase has the perfect
              room for every task.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8">
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 hover:border-white/20 hover:bg-white/8 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl text-white mb-3 group-hover:text-purple-300 transition-colors duration-300">
                  Coding Room
                </h3>
                <p className="text-white/70 leading-relaxed mb-4 group-hover:text-white/90 transition-colors duration-300">
                  Integrated online IDE with syntax highlighting, real-time
                  collaborative editing, and instant code sharing.
                </p>
                <ul className="space-y-2">
                  {[
                    ...
                    <li
                      key={feature}
                      className="flex items-center gap-2 text-sm text-white/60 group-hover:text-white/80 transition-colors duration-200"
                    >
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 hover:border-white/20 hover:bg-white/8 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl text-white mb-3 group-hover:text-orange-300 transition-colors duration-300">
                  Whiteboard
                </h3>
                <p className="text-white/70 leading-relaxed mb-4 group-hover:text-white/90 transition-colors duration-300">
                  Infinite collaborative canvas for brainstorming, sketching
                  ideas, and visual planning with your team.
                </p>
                <ul className="space-y-2">
                  {[
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 hover:border-white/20 hover:bg-white/8 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl text-white mb-3 group-hover:text-blue-300 transition-colors duration-300">
                  Meeting Room
                </h3>
                <p className="text-white/70 leading-relaxed mb-4 group-hover:text-white/90 transition-colors duration-300">
                  High-quality video calls with screen sharing, chat, and
                  meeting controls for seamless virtual meetings.
                </p>
                <ul className="space-y-2">
                  {["HD video & audio", "Screen sharing", "Real-time chat"].map(
                    (feature) => (
                      <li
                        key={feature}
                        className="flex items-center gap-2 text-sm text-white/60 group-hover:text-white/80 transition-colors duration-200"
            ...
            <div className="group relative overflow-hidden rounded-2xl border border-white/10 bg-white/5 p-8 hover:border-white/20 hover:bg-white/8 transition-all duration-500">
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl text-white mb-3 group-hover:text-green-300 transition-colors duration-300">
                  Kanban Board
                </h3>
                <p className="text-white/70 leading-relaxed mb-4 group-hover:text-white/90 transition-colors duration-300">
                  Visual task management with drag-and-drop cards, custom
                  columns, and real-time updates for agile teams.
                </p>
                <ul className="space-y-2">
                  {[
                    "Drag & drop cards",
      ...
      <section
        id="how"
        className="relative sm:py-28 section-divider pt-20 pb-20 z-10"
      >
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            <div
              className="opacity-0 animate-slide-in-left animate-delay-300"
              style={{ opacity: 1 }}
            >
              <h2 className="text-3xl sm:text-4xl text-white mb-6 tracking-tighter">
                From idea to execution,{" "}
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-sky-400 to-indigo-400 tracking-tighter">
                  without switching tools
                </span>
              </h2>
              <p className="text-lg text-white/70 mb-8 leading-relaxed">
                Create workspaces for different projects and teams. Each
                workspace contains specialized rooms that sync in real-time,
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-4 group hover:bg-white/5 rounded-lg p-3 transition-all duration-200">
                  ...
                  <div>
                    <h4 className="font-semibold text-white mb-1 group-hover:text-sky-300 transition-colors duration-200">
                      Create unlimited workspaces
                    </h4>
                    <p className="text-white/70 text-sm group-hover:text-white/90 transition-colors duration-200">
                      Organize your team with separate workspaces for projects,
                ...
                <div className="flex items-start gap-4 group hover:bg-white/5 rounded-lg p-3 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm group-hover:text-white/90 transition-colors duration-200">
                      Each workspace can contain coding, whiteboard, meeting,
                      and Kanban rooms.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex items-start gap-4 group hover:bg-white/5 rounded-lg p-3 transition-all duration-200">
                  ...
                  <div>
                    ...
                    <p className="text-white/70 text-sm group-hover:text-white/90 transition-colors duration-200">
                      Share workspace access and collaborate with your team in
                      real-time.
                    </p>
                  </div>
                </div>
            ...
            <div
              className="opacity-0 animate-slide-in-right animate-delay-400"
              style={{ opacity: 1 }}
            >
              <div className="relative">
                    ...
                    <div className="space-y-4">
                      <div className="flex items-center justify-between p-3 rounded-lg bg-white/5 border border-white/10 hover:bg-white/10 hover:border-white/15 transition-all duration-300 group">
                        <div className="flex items-center gap-3">
                          ...
                          <div>
                            <p className="text-sm font-medium text-white group-hover:text-sky-300 transition-colors duration-200">
                              Code deployed
                            </p>
                        ...
                        <span className="text-xs font-mono text-green-400 group-hover:scale-110 transition-transform duration-200">
                          ✓ main
                        </span>
                      </div>
      ...
      <section
        id="pricing"
        className="relative max-w-7xl mr-auto ml-auto pt-20 pr-6 pb-20 pl-6 z-10"
      >
        <div className="mx-auto max-w-3xl text-center">
          <h1 className="sm:text-4xl text-3xl text-neutral-50 tracking-tighter">
            Choose Your VBase Plan
          </h1>
          <p className="mt-3 text-white/70">
            Fast, powerful, collaborative. Pick the plan that fits your
            team&apos;s needs.
          </p>
        </div>

        <div
          className="grid gap-8 sm:grid-cols-2 lg:grid-cols-3 mt-14"
        ...
        >
          ...
          <div className="group relative">
            <div className="relative w-full overflow-visible [perspective:1200px]">
              ...
              <div
                className="relative z-10 rounded-[28px] shadow-2xl p-7 sm:p-8 min-h-[420px] flex flex-col justify-between [transform-style:preserve-3d] origin-left [transform:rotateY(0deg)] transition-transform duration-700 ease-[cubic-bezier(.2,.7,.2,1)] group-hover:[transform:rotateY(-10deg)_translateY(-12px)_translateZ(10px)] transform-gpu"
                style={{
                  background:
              ...
              >
                <div>
                  <div className="text-center">
                    <div className="text-xs tracking-[0.2em] text-white/70 mb-3">
                      STARTER
                    </div>
                    <div className="text-5xl leading-none text-white tracking-tighter">
                      Free
                    </div>
            ...
            <div className="relative w-full overflow-visible [perspective:1200px]">
              ...
              <div
                ...
                style={{
                  ...
                  boxShadow:
                    "0 8px 32px rgba(56,189,248,0.2), inset 0 1px 0 rgba(255,255,255,0.2)",
                }}
              >
                <div>
                  <div className="text-center">
                    <div className="text-xs tracking-[0.2em] text-sky-300 mb-3">
                      PRO
                    </div>
                    <div className="text-5xl leading-none text-white tracking-tighter">
                      $15<span className="text-lg align-super">/mo</span>
                    </div>
          ...
          <div className="group relative">
            <div className="relative w-full overflow-visible [perspective:1200px]">
              ...
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(168,85,247,0.15), rgba(147,51,234,0.08))",
                  backdropFilter: "blur(20px)",
              ...
              >
                <div>
                  <div className="text-center">
                    <div className="text-xs tracking-[0.2em] text-violet-300 mb-3">
                      ENTERPRISE
                    </div>
                    <div className="text-5xl leading-none text-white tracking-tighter">
                      $49<span className="text-lg align-super">/mo</span>
                    </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div className="md:col-span-2">
              ...
              <p className="text-white/60 text-sm max-w-md mb-6">
                The ultimate collaborative virtual workspace with integrated
                coding, whiteboards, video meetings, and Kanban boards.
              </p>
          ...
          <div className="flex flex-col sm:flex-row border-white/10 border-t mt-12 pt-8 items-center justify-between">
            <p className="text-white/50 text-sm">
              © 2026 VBase. All rights reserved.
            </p>
            <div className="flex items-center gap-6 text-sm mt-4 sm:mt-0">
              <a
                href="#"
                className="text-white/50 hover:text-white/70 hover:scale-105 transition-all duration-200"
              >
                Privacy
              </a>
              <a
