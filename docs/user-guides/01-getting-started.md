...
![VBase landing page with the Get Started button visible.](../media/screenshots/getting-started-01-landing-page-get-started.png)
...
![Dashboard header with the theme toggle visible.](../media/screenshots/getting-started-06-dashboard-theme-toggle.png)
