...
![My Workspaces page with the Create Workspace button highlighted.](../media/screenshots/workspaces-01-dashboard-create-button.png)
Caption: Use Create Workspace to start a new collaborative space.

![Create Workspace modal with workspace name input and action buttons.](../media/screenshots/workspaces-02-create-workspace-modal.png)
...
![Dashboard workspace cards displayed in the My Workspaces grid.](../media/screenshots/workspaces-03-workspace-card-grid.png)
...
![Workspace Settings modal with Manage Members tab open.](../media/screenshots/workspaces-06-workspace-settings-modal.png)
